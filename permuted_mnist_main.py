...
if __name__ == '__main__':
    for i in range(10):
        ...
        args = dict(seed_number=seed_number,n_task=10,tag="test_basic_network",n_epochs=20,n_f_epochs=50,entropy_dependent_lr=False,homogeneous_lr=False,model_hidden_sizes=[20*20,10*10,10*10,5*5])
